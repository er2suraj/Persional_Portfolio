    ...
    <div>
        ...
        <div className="nav">
          ...
          <div className="navlink">
            <ul>
              ...
              {/* <li className="servicel nav-hover"><a href="#Service">Service</a></li> */}
      ...
      <div id="About">
        ...
        <div className="AboutText">
          ...
          <button id="aboutMe">More About Me</button>
        </div>
      </div>

      <div className="skills" id="Skill">
        <h1>My <span style={{ color: 'aqua' }}>Skills</span></h1>
...
{/* project section  */}
      <div className="projects" id='Project'>
        ...
        <ul className='project_list'>
          <li>
            <b style={{color: 'aqua'}}>Recipe Finder Web App:</b> 
            <p>
          ...
          <li>
            <b style={{color: 'aqua'}}>N-Queens Visualizer: </b> 
            <p>
          ...
          <li>
            <b style={{color: 'aqua'}}> Web Projects: </b> 
            <p>
      ...
      <div className="contact" id='Contact'>
        <p>
          Contact number : <a href="tel:+6392227274">6392227274</a>
        </p>
      </div>
    </div>
  );
